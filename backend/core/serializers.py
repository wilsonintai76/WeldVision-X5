...
class AnnotationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Annotation
        fields = ['id', 'class_name', 'x_center', 'y_center', 'width', 'height', 'created_at']
...
class LabeledImageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = LabeledImage
        fields = ['id', 'dataset', 'image', 'image_url', 'filename', 'width', 'height', 
...
class DatasetSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'description', 'classes', 'created_by', 
                  'created_at', 'updated_at', 'image_count', 'annotated_count', 'images']
