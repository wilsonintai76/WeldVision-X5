    ...
    <div className="p-8 space-y-6">
                  ...
                  <tr key={model.id} className="border-b border-industrial-gray/50 hover:bg-industrial-dark transition-colors">
                    ...
                    <td className="py-4 px-4 text-right">
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${model.is_deployed
            ...
            <div>
              ...
              <div className="flex gap-1 mb-3">
                <button
                  ...
                  className={`flex-1 px-3 py-2 text-xs font-medium rounded-lg transition-colors ${convertSource === 'model'
                ...
                <button
                  ...
                  className={`flex-1 px-3 py-2 text-xs font-medium rounded-lg transition-colors ${convertSource === 'job'
                    ? 'bg-blue-600 text-white'
                    : 'bg-industrial-slate text-slate-400 hover:bg-industrial-gray'
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex-1 px-3 py-2 text-xs font-medium rounded-lg transition-colors ${convertSource === 'manual'
                    ? 'bg-blue-600 text-white'
                    : 'bg-industrial-slate text-slate-400 hover:bg-industrial-gray'
                    }`}
                >
      ...
      <div className="mt-6 p-4 bg-gradient-to-r from-blue-950/30 to-purple-950/30 rounded-lg border border-blue-600/50">
        ...
        <button
          ...
          className={`mt-4 w-full px-4 py-3 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2 ${uploading || !uploadFile || !uploadForm.name || !uploadForm.version
              ...
              {jobs.map((j) => (
                <tr key={j.id} className="border-b border-industrial-gray/50">
                  ...
                  <td className="py-2 px-3">
                    <span className={`text-sm font-semibold ${j.status === 'succeeded' ? 'text-green-400' :
                  ...
                  <td className="py-2 px-3 text-right space-x-2">
                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded-lg text-sm ${j.status === 'succeeded'
